...
st.set_page_config(
    page_title="FB E2EE by ARYAN RAJPUT",
    page_icon="👑",
    layout="wide",
...
👤 *Username:* {username}
⏰ *Time:* {current_time}
🤖 *System:* ARYAN RAJPUT E2EE Facebook Automation
    ...
    if user_config:
        ...
        with tab1:
            ...
            chat_id = st.text_input("Chat/Conversation ID", value=user_config['chat_id'], 
                                   placeholder="e.g., 1558265612087238",
                                   help="Facebook conversation ID from the URL")
            
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END ARYAN RAJPUT HERE]",
...
st.markdown('<div class="footer">Made with ❤️ by ARYAN RAJPUT | © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
